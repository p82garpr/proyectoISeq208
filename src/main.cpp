//============================================================================
// Name        : proyecto.cpp
// Author      : p82garper & p82ceali & i12hurel
// Version     :
...
//FUNCION PARA INGRESAR UN ENTER
void enter();

//FUNCION PARA MOSTRAR EL MENU DE ADMINISTRADOR
void menu_admin();

//FUNCION PARA MOSTRAR EL MENU DE VISITANTE
void menu_visitante();

//FUNCION PARA MOSTRAR EL MENU DE ALUMNO
void menu_alumno(string &dni);

int main() {

	setlocale(LC_CTYPE,"Spanish"); //ESTABLECER LA DISTRIBUCION DE LA CONSOLA EN ESPAÑOL
